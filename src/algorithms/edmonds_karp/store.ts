...
import { config, IFordFulkersonConfig, VisualisationStateRS, VisualisationStateTS } from "../ford_fulkerson/config";
...
export interface EdmondsKarpStore extends IAlgorithmStore {
	/**
...
export const useEdmondsKarpStore = create<EdmondsKarpStore>()((set, get) => ({
	isInitialized: false,
	pseudoCode: null,
	visState: null,
