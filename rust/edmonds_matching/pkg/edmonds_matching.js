...
if (Symbol.dispose) Properties.prototype[Symbol.dispose] = Properties.prototype.free;
...
if (Symbol.dispose) PropertyRequirements.prototype[Symbol.dispose] = PropertyRequirements.prototype.free;
...
async function __wbg_init(module_or_path) {
    ...
    if (typeof module_or_path === 'undefined') {
        module_or_path = new URL('edmonds_matching_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
