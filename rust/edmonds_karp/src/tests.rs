use crate::{edmonds_karp, EdmondsKarpPseudocode::*, EdmondsKarpVisualisationState};
...
fn check_line1(state: EdmondsKarpVisualisationState) {
...
fn check_line3(state: EdmondsKarpVisualisationState) {
...
fn check_line4(state: EdmondsKarpVisualisationState) {
...
fn check_line5(_state: EdmondsKarpVisualisationState) {
...
fn test_graph_simple_example() {
	...
	let state = EdmondsKarpVisualisationState::new(graph.clone(), 0);
	let sm = StateMachine::new(|out| edmonds_karp(state, out));
	// Run macro
	test_run!(sm => [
